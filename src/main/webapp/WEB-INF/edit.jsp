...
<body>
    <div class="container mx-auto mt-5  p-4 bg-light text-dark" style="width: 500px;">
        <h1>Edit Task</h1>
        <form:form action="/tasks/${task.id}" method="post" modelAttribute="task">
            ...
            <div class="form-group mb-3">
                ...
                <form:errors path="assignee" class="form-text text-danger"></form:errors>
            ...
            <div class="form-group mb-3">
                ...
                <form:errors path="priority" class="form-text text-danger"></form:errors>
